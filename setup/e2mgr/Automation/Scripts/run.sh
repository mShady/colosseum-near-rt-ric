...
#docker pull nexus3.o-ran-sc.org/ric-plt-e2:$E2T_TAG
#docker pull nexus3.o-ran-sc.org/ric-plt-e2mgr:$E2M_TAG
...
#docker run -d --name e2mgr -p 3800:3800 -p 3801:3801 --env DBAAS_SERVICE_HOST=10.0.2.15 --env RMR_VCTL_FILE=/tmp/rmr.verbose nexus3.o-ran-sc.org/ric-plt-e2mgr:$E2M_TAG
...
sleep 2
#docker create --name e2 --env sctp=5577 --env nano=38000 --env loglevel=debug --env print=1 -p 38000:38000 nexus3.o-ran-sc.org/ric-plt-e2:$E2T_TAG
...
#docker pull nexus3.o-ran-sc.org/ric-plt-e2mgr:$E2M_TAG
docker pull snapshot.docker.ranco-dev-tools.eastus.cloudapp.azure.com:10001/e2mgr:$E2M_TAG
#docker run -d --name e2mgr -p 3800:3800 -p 3801:3801 --env RMR_RTG_SVC=10.0.2.15 --env DBAAS_SERVICE_HOST=10.0.2.15 nexus3.o-ran-sc.org/ric-plt-e2mgr:$E2M_TAG
